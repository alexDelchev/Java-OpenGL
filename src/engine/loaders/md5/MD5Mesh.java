...
public class MD5Mesh {
	...
	public String toString(){
		...
		str.append("text: " ).append(texture).append(System.lineSeparator());
		...
		for(String line: meshBlock){
			if(line.contains("shader")){
				...
				if(textureMatcher.matches()){
					...
					System.out.println(mesh.texture);
				}
				...
				if(triMatcher.matches()){
					...
					triangle.setIntex(Integer.parseInt(triMatcher.group(1)));
	...
	public static class MD5Triangle{
		...
		private int vertex0, vertex1, vertex2;
		
		public int getIndex(){
			return index;
		}
		
		public void setIntex(int index){
			this.index = index;
		}
		...
		public void setVertex0(int vertex){
			this.vertex0 = vertex;
		}
